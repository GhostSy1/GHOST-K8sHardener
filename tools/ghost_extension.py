...
TOOL = "GHOST-K8sHardener"
VERSION = "3.0-PRO"
PROFILE = "Kubernetes manifest security and RBAC hardener"
RULES = [('K8S-PRIV', 'privileged:\\s*true|hostPID:\\s*true|hostNetwork:\\s*true'), ('K8S-FS', 'hostPath|hostIPC|allowPrivilegeEscalation'), ('K8S-IMAGE', 'imagePullPolicy|:latest|image:')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-K8sHardener v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
